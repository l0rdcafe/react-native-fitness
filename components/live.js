  ...
  componentDidMount() {
    Permissions.getAsync(Permissions.LOCATION)
      ...
      .catch(err => {
        ...
        this.setState({ status: "undeteremined" });
      });
  }
  setLocation = () => {
  ...
  render() {
      ...
      return (
        <View style={styles.center}>
          ...
          <Text style={{ textAlign: "center", fontSize: 15 }}>
            You denied your location. You can fix this by visiting your settings and enabling services for this app.
          </Text>
        </View>
      );
    }
    ...
    if (status === "undetermined") {
      return (
        <View style={styles.center}>
          <Foundation name="alert" size={50} />
          <Text style={{ textAlign: "center", fontSize: 15 }}>You need to enable location services for this app.</Text>
